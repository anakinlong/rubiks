...
class ColourTest(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.colour = rubiks.Colour([1, 2, 3], channel_format=["b", "g", "r"])
    ...
    def test_reformat(self) -> None:
        ...
        equivalent_colour = rubiks.Colour([3, 2, 1], channel_format=["r", "g", "b"])
    ...
    def test_colour_average_unweighted(self) -> None:
        ...
        colour_1 = rubiks.Colour([1, 2, 3], channel_format=["r", "g", "b"])
        colour_2 = rubiks.Colour([10, 20, 30], channel_format=["g", "b", "r"])
        colour_average = rubiks.Colour.colour_average(colour_1, colour_2)
        # Create an equivalent colour:
        equivalent_colour = rubiks.Colour([16, 6, 12], channel_format=["r", "g", "b"])
    ...
    def test_colour_average_weighted(self) -> None:
        ...
        colour_2 = rubiks.Colour([10, 20, 30], channel_format=["g", "b", "r"])
        weights = [1, 2]
        colour_average = rubiks.Colour.colour_average(colour_1, colour_2, weights=weights)
        # Create an equivalent colour:
        equivalent_colour = rubiks.Colour([20, 7, 14], channel_format=["r", "g", "b"])
        self.assertEqual(colour_average, equivalent_colour)
    ...
    def test_validate_iterable_iterable_type(self) -> None:
        ...
        with self.assertRaises(TypeError):
            rubiks.Colour._Colour__validate_iterable(3)
    ...
    def test_validate_iterable_value(self) -> None:
        ...
        with self.assertRaises(ValueError):
            rubiks.Colour._Colour__validate_iterable([1, 2, 3, 4])
    ...
    def test_validate_iterable_element_type(self) -> None:
        ...
        """
        with self.assertRaises(TypeError):
            rubiks.Colour._Colour__validate_iterable(["1", "2", "3"])
    ...
    def test_validate_channel_format_channel_format_type(self) -> None:
        ...
        """
        with self.assertRaises(TypeError):
            rubiks.Colour._Colour__validate_channel_format(3)
    ...
    def test_validate_channel_format_value(self) -> None:
        ...
        """
        with self.assertRaises(ValueError):
            rubiks.Colour._Colour__validate_channel_format(["1", "2", "3", "4"])
    ...
    def test_validate_channel_format_element_type(self) -> None:
        ...
        """
        with self.assertRaises(TypeError):
            rubiks.Colour._Colour__validate_channel_format([1, 2, 3])
    ...
    def test_validate_channel_format_element_duplicates(self) -> None:
        ...
        """
        with self.assertRaises(ValueError):
            rubiks.Colour._Colour__validate_channel_format(["1", "1", "2"])
